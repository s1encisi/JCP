...
CONFIG_FILE = str(MODEL_OUTPUT_ROOT / 'as_config.json')
...
THREE_STAGE_CONFIG = {
    ...
    'MANUAL_RANDOM_STATE': 250,            # USE_OPTIMIZED_RANDOM_STATE=False 时生效
    'USE_BAYESIAN_OPTIMIZATION': False,     # True=贝叶斯优化超参数
    'OUTPUT_DIR': str(MODEL_OUTPUT_ROOT / 'as_three_stage'),
...
FOUR_STAGE_CONFIG = {
    ...
    'MANUAL_RANDOM_STATE': 325,
    'USE_BAYESIAN_OPTIMIZATION': False,
    'OUTPUT_DIR': str(MODEL_OUTPUT_ROOT / 'as_four_stage'),
...
SERIAL_CONFIG = {
    'USE_OPTIMIZED_RANDOM_STATE': False,
    'MANUAL_RANDOM_STATE': 143,
    'USE_BAYESIAN_OPTIMIZATION': False,
    'OUTPUT_DIR': str(MODEL_OUTPUT_ROOT / 'as_serial'),
    'SHEET_NAME': 'serial',
    'MODEL_TAG': 'serial',
    'FEATURE_COLS': [
        '电积前液Cu（g/L）',
...
if __name__ == "__main__":
    print("=" * 120)
    print("废铜液原液罐As（g/L）预测模型 —— 整合版 v3")
    ...
    tag_map = {
        'three_stage': ('outputs/as_three_stage', 'prediction_results_three_stage_train.xlsx',
                        'prediction_results_three_stage_test.xlsx'),
        'four_stage':  ('outputs/as_four_stage',  'prediction_results_four_stage_train.xlsx',
                        'prediction_results_four_stage_test.xlsx'),
        'serial':      ('outputs/as_serial',       'prediction_results_serial_train.xlsx',
    ...
    try:
        ...
        # 输出到Excel文件
        excel_path = f'{output_dir}/as_metrics_summary.xlsx'
